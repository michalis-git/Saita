...
void Box2DFixture::updateTest(b2Body *body)
{
//    b2Shape::Type t = mFixtureDef.shape->GetType();

//    if(t == b2Shape::e_polygon){
//        b2Shape *shp = createShape();

//        mFixtureDef.shape = shp;
//    }
//    mFixtureDef.shape = NULL;
//    mFixtureDef.shape = createShape();
    body->DestroyFixture(mFixture);
}


void Box2DFixture::updateTest2(b2Body *body)
{
//    b2Shape::Type t = mFixtureDef.shape->GetType();
