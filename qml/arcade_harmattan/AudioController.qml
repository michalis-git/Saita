...
//        }
    ...
    AudioMixer {
        ...
        AudioBuffer {
            id: music
            source: "/opt/saita2/qml/arcade_harmattan/assets/audio/music/main_theme.wav"
        }

        AudioBuffer {
            id: lostMusicAudio
            source: "/opt/saita2/qml/arcade_harmattan/assets/audio/music/lost.wav"
        }

        AudioBuffer {
            id: winAudio
            source: "/opt/saita2/qml/arcade_harmattan/assets/audio/music/victory.wav"
        }
    }
}
