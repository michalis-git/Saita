...
//        rotation: saita.linearVelocity.y > 0? 0:-10
    ...
    states: [
        ...
        State{
            ...
            StateChangeScript{ name: "bulletScript1"; script: { console.log('bullet script 1 ..'); saita.linearVelocity = Qt.point(saita.linearVelocity.x*1.35,saita.linearVelocity.y); } }
            StateChangeScript{ name: "bulletScript2"; script: { console.log('bullet script 2 ..'); saita.linearVelocity = Qt.point(saita.linearVelocity.x*1.35,saita.linearVelocity.y); } }
    ...
    transitions: [
        Transition{
            ...
            SequentialAnimation{
                ...
                PropertyAnimation { target:saitaImage; property:"source"; from:imagebullet2; to: imagebullet1; duration:350 }
                ScriptAction{ scriptName: "bulletScript2" }
                PropertyAnimation { target:saitaImage; property:"source"; from:imagebullet1; to: imagebullet; duration:350 }
