...
Body {
    ...
    property int bottomBorderLimit: worldClassroom.height - (2*worldClassroom.floorWallHeight)
    ...
    Timer{
        ...
        onTriggered: { if(bodyItem.height < bottomBorderLimit){ cableHeight += 1; updateFixtures() }else{ timerRunning = false; } }
    }
