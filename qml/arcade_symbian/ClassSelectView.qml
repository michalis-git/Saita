...
//            border.color: "lightgrey"
            ...
            Column{
                ...
                Text {
                    ...
                    font.pointSize: container.opacity==1.0? 12: 10
//                    font.family: arcadeCanvas.localFont.name
                ...
                Text {
                    text: description
                    anchors.horizontalCenter: parent.horizontalCenter
                    font.pointSize: container.opacity==1.0?10:8
                    font.bold: container.opacity==1.0?true:false
//                    font.family: arcadeCanvas.localFont.name
                    font.family: "Comic Sans MS"
                    color: "white"
                ...
                Row{
                    ...
                    Text{
                        ...
                        color: "white";
                        anchors.verticalCenter: parent.verticalCenter
                        font { pointSize: container.opacity==1.0?9:7; bold:container.opacity==1.0?true:false; family: arcadeCanvas.localFont.name }
                    }
...
//                    RatingIndicator{ maximumValue: 4; ratingValue: 2; inverted: true; anchors.verticalCenter: parent.verticalCenter }
                ...
                Row{
                    ...
                    Text{
                        ...
                        font { pointSize: 10; family: arcadeCanvas.localFont.name }
                        color: "lightgrey"
                    }
                }
            }
