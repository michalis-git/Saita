...
Item {
    ...
    function start(){
        ...
        if(adsCounter>2 && adsCounter%3 == 0)
            readyForAds()
    }
...
//            font.family: arcadeCanvas.localFont.name
    ...
    SequentialAnimation{
        ...
        NumberAnimation{ target: gradeText; duration: 300; properties: "font.pointSize"; from: 10; to: 13; easing.type: Easing.OutQuad}
        NumberAnimation{ target: gradeText; duration: 300; properties: "font.pointSize"; from: 13; to: 10; easing.type: Easing.InCubic}
    ...
    SequentialAnimation{
        ...
        NumberAnimation{ target: badgeImage; duration: 300; properties: "width,height"; from: 36; to: 48; easing.type: Easing.OutQuad }
        NumberAnimation{ target: badgeImage; duration: 300; properties: "width,height"; from: 48; to: 36; easing.type: Easing.InCubic }
    }
}
