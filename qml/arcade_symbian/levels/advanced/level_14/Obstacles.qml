...
Item {
    property int obstaclesSpacing: 75
    ...
    BasketBallComponent{
        ...
        bRestitution: 0.97
        initialLinearVelocity: Qt.point(0,195)
    }
    ...
    BasketBallComponent{
        ...
        bRestitution: 0.98
        initialLinearVelocity: Qt.point(0,150)
    }
    ...
    ResizableCeilingLight{
        ...
        timerInterval: timerInterval*1.7
    }
    ...
    ResizableCeilingLight{
        ...
        timerInterval: timerInterval*1.1
    }
