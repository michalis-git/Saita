...
Item{
    ...
    //
    property int saitaSpeed: 160

    property int initialSaitaSpeed: 160
...
//    property real backgroundLevel1OffsetValue: saitaSpeed*0.0157
    property real kvalue: saitaSpeed == 160?0.0168:0.036
...
//        width: foreground.contentWidth
    ...
    BonusPanel{
        ...
        anchors{ top: parent.top; topMargin: 35; left: parent.left; leftMargin: 5 }
    }
