        ...
        var object = component.createObject(foreground.worldClassroom,
                                            {
                                                ...
                                                "x": foreground.worldClassroom.width-foreground.obstacles.obstaclesSpacing,
                                                "y": foreground.worldClassroom.height*((6-helperCounter)/7),
                                                "force": ((6-helperCounter)/3)*-25
                                            } );
        object.z = 200
        object.linearVelocity = Qt.point(-75,0)
        object.bottomBorder = foreground.worldClassroom.height* ((6-helperCounter)/7)
