...
Item{
    ...
    Body {
        ...
        fixtures: Circle {
            ...
            onBeginContact: { if(classroom.running && bodyItem.y >= worldClassroom.height - worldClassroom.floorWallHeight-containerItem.height-2)levelView.playBounceSoundEffect(); else console.log('cannot play bounce effect bodyItem.y : ' + bodyItem.y) }
        }
