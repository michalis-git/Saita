...
Item{
    ...
    Body {
        id: rodItem
        x: fallingCeilingLight.x + fallingCeilingLight.width/2 - 4
...
//        anchors.top: rodItem.bottom
        ...
        fixtures: [
            Polygon {
                id: lampFixture
                vertices: [
                    Qt.point(29,cableHeight),
                    Qt.point(4,cableHeight+84),
                    Qt.point(76,cableHeight+85),
                    Qt.point(49,cableHeight)
                ];
