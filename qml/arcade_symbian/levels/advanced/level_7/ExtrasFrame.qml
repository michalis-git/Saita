...
Item {
    ...
    Bonus{
        ...
        y: worldClassroom.height - worldClassroom.floorWallHeight - height - 8
    ...
    Bonus{
        id: bonus2
        x: obstacles.fallingLampEndX + 15
    ...
    SpecialEffectBullet{
        id: specialeffect1
        x: obstacles.lampStartX - (3.2*obstacles.lampSpacing)
        y:worldClassroom.ceilingWallHeight + 8
        parent: worldClassroom
