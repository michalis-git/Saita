...
Item {
    ...
    property int firnitureSpacing: 75
    ...
    function createBasketBall(){
        ...
        if(component.status == Component.Ready){
            var object = component.createObject(worldClassroom,{"x": worldClassroom.width-obstacles.firnitureSpacing, "y": worldClassroom.height/3, "initialLinearVelocity": Qt.point(-130,52) } );
            object.z = 200
        }else
