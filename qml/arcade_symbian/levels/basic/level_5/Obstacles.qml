...
Item {
    ...
    property variant firstBonusPos: Qt.point(obstacle1.x-spacing/2,worldClassroom.ceilingWallHeight+spacing/4)
    ...
    Component.onCompleted: {
        obstacle3.squeekTimer.running = false
        obstacle4.squeekTimer.running = false
    }
}
