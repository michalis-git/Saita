    ...
    Column{
        ...
        Item{
            ...
            MouseArea{
                id: resumeArea
                anchors.fill: parent
                onClicked: { /*pageMain.audioController.playTapSoundEffect();*/ resumeClicked() }
            }
        }
        ...
        Item{
            ...
            MouseArea{
                id: mainMenuArea
                anchors.fill: parent
                onClicked: { /*pageMain.audioController.playTapSoundEffect();*/ mainMenuClicked() }
            }
        }
        ...
        Item{
            ...
            MouseArea{
                id: musicArea
                anchors.fill: parent
                onClicked: { /*pageMain.audioController.playTapSoundEffect(); */ pageMain.musicMuted = !pageMain.musicMuted; pageMain.soundEffectsMuted = !pageMain.soundEffectsMuted; pageMain.soundEffectsMuted = !pageMain.soundEffectsMuted }
            }
        }
    }
}
