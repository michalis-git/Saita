    ...
    Hand{
        ...
        MouseArea{
            ...
            onPositionChanged: {
                ...
                if(!classroom.running && !paused && mapToItem(foreground,mouse.x,mouse.y).y > 100 && mapToItem(foreground,mouse.x,mouse.y).y < foreground.height - 120){
