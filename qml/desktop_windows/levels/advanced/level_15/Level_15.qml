...
//    property alias mArea: foreground.mArea
    ...
    function doNotShowTipsOnStart(){
        pageMaind.showTipsOnStart = false;
    }

    //
    //
    //
    anchors.fill: arcadeCanvas
...
//        width: foreground.contentWidth
    ...
    Timer{
        id: helperTimer
        running: foreground.worldClassroom.running
        repeat: true
        interval: 3000
        triggeredOnStart: true

        onTriggered: {
            Engine.createEnemySaita();
        }
    }
...
//                    pageMain.audioController.playMusic();
        ...
        State{
            ...
            StateChangeScript{ name: "winScript"; script: { /*pageMain.audioController.stopMusic();*/ classroom.win(level,bonusCounter) } }
