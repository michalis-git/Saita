...
Item{
    ...
    Body {
        ...
        fixtures: Circle {
            ...
            onBeginContact: { if(worldClassroom.mapFromItem(bodyItem,circle.x,circle.y).y < worldClassroom.height - containerItem.height - worldClassroom.floorWallHeight - 5){ containerItem.state = 'inActive' } }
        }
