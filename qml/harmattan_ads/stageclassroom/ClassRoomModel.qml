...
ListModel {
    ListElement{
        ...
        background:[
            ListElement{
                level1: ListElement{ path: "images/background/outdoors/sky_1.png"; width: 854; height: 480 }
                level2: ListElement{ path: "images/background/outdoors/trees_1.png"; width: 854; height: 480 }
                level3: ListElement{ path: "images/background/walls/a.png"; width: 854; height: 480 }
            },
            ListElement{
                level1: ListElement{ path: "images/background/outdoors/sky_2.png"; width: 376; height: 480 }
                level2: ListElement{ path: "images/background/outdoors/trees_2.png"; width: 376; height: 480 }
                level3: ListElement{ path: "images/background/walls/b.png"; width: 854; height: 480 }
            },
            ListElement{
                level1: ''
                level2: ''
                level3: ListElement{ path: "images/background/walls/c.png"; width: 854; height: 480 }
            },
            ListElement{
                level1: ''
                level2: ''
                level3: ListElement{ path: "images/background/walls/d.png"; width: 804; height: 480 }
            }
        ]
