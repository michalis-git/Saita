...
Item {
            ...
            Item{
                ...
                Row{
                    ...
                    Text{
                        id: bonusText
                        text: bonusItems
                        font{ pointSize: 9; bold: true; family: canvas.localFont.name }
                        color: "blue"
                        anchors.verticalCenter: parent.verticalCenter

                        Behavior on text {
                            SequentialAnimation{
                                NumberAnimation { target: bonusText; property: "font.pointSize"; to: 10; duration: lostMenuTimer.interval * 0.5 }
                                PropertyAnimation { target: bonusIcon; property: "source"; to: "assets/images/extras/apple.png"; duration: lostMenuTimer.interval * 0.1 }
                                NumberAnimation { target: bonusText; property: "font.pointSize"; to: 9; duration: lostMenuTimer.interval * 0.4 }
                            }
                        }
                    }
                }
                ...
                Row{
                    ...
                    Text{
                        ...
                        Behavior on text {
                             SequentialAnimation {
                                 NumberAnimation { target: scoreText; property: "font.pointSize"; to: 10; duration: lostMenuTimer.interval / 2 }
                                 NumberAnimation { target: scoreText; property: "font.pointSize"; to: 9; duration: lostMenuTimer.interval / 2 }
                             }
                         }
                    }
    ...
    PopUp{
        ...
        opacity: 0.0
        z: 100
//        onNameChanged: lostMenu.nameChanged(name)
