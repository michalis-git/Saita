...
Item{
    ...
    property int score : classRoomSaita.x / 120
    ...
    Flickable{
        ...
        Hand{
            id: hand
            x:0
            y:flickable.contentHeight/2+15
            width: 60
            height: 53
            z:200
        }
        ...
        World {
            ...
            property int groundWallHeight: 23
            property int ceilingWallHeight: 23
            ...
            Saita{
                ...
                onXChanged: {
                    ...
                    {
                        // advance the score
                        classroom.score = classRoomSaita.x / 120;
    ...
    StartText{
        ...
        anchors.topMargin: worldClassroom.ceilingWallHeight + 29 - 5
        anchors.top: parent.top
    }
    ...
    StartText{
        ...
        z: 20
        anchors.horizontalCenter: parent.horizontalCenter
        anchors.bottomMargin: worldClassroom.groundWallHeight + 29 + 53 - 5
        anchors.bottom: parent.bottom
    }
    ...
    Text{
        ...
        font{ bold: true; family: canvas.localFont.name; pointSize: 9 }
        anchors { top: parent.top; topMargin: 25; right: parent.right; rightMargin: 6 }
        color: "#0036fb"
        z: 10
    }
    ...
    BonusPanel{
        ...
        anchors{ top: parent.top; topMargin: 31; left: parent.left; leftMargin: 6 }
    }
