...
Body {
    ...
    property int currentCenterX: x - (classroom.width / 5)
    ...
    Image{
        id: fingerImage
        anchors{ bottom: parent.bottom; bottomMargin: -5; horizontalCenter: parent.horizontalCenter; horizontalCenterOffset: 5 }
    ...
    states: [
        ...
        State{
            ...
            StateChangeScript{ name: "bulletScript1"; script: saita.linearVelocity = Qt.point(saita.linearVelocity.x*1.23,saita.linearVelocity.y); }
            StateChangeScript{ name: "bulletScript2"; script: saita.linearVelocity = Qt.point(saita.linearVelocity.x*1.23,saita.linearVelocity.y); }
            StateChangeScript{ name: "bulletScript3"; script: saitaImage.source = imagebullet }
    ...
    transitions: [
        Transition{
            ...
            SequentialAnimation{
                PropertyAnimation { target:saitaImage; property:"source"; to: imagebullet2; duration:200 }
                ScriptAction{ scriptName: "bulletScript1" }
                PropertyAnimation { target:saitaImage; property:"source"; from:imagebullet2; to: imagebullet1; duration:500 }
                ScriptAction{ scriptName: "bulletScript2" }
                PropertyAnimation { target:saitaImage; property:"source"; from:imagebullet1; to: imagebullet; duration:500 }
