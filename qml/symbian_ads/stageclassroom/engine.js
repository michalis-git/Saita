...
// gameplay parameters
var speedValues = new Array(150,203,255); // easy [200] , medium[270] , expert[340]
var gravityValues = new Array(-5,-7,-9) // easy [-5] , medium [-7] , expert[-9]
var forceValues = new Array(24,31,35); // easy [24] , medium [31] , expert[35]
...
var helperArray1 = new Array(640,640,640);  // used to fine tune the 1st background level element when worldClassroom advances
var helperArray2 = new Array(280,280,280);  // used to fine tune the 2nd background level element when worldClassroom advances
...
var specialEffectChanceValue = 8;
...
function setSaitaSpeed(val){
    saitaSpeed = val;
    classRoomSaita.linearVelocity = Qt.point(val,0);
}
...
function reset(){
    ...
    classRoomSaita.x = hand.width-46
